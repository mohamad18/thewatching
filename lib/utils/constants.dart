...
import 'package:thefilms/screens/home_screen.dart';
...
const kThetvdbURL = "https://api.themoviedb.org/3/tv";
const kHomeScreenButtonZeroText = "Now Playings";
...
const kTVScreenButtonZeroText = "Airing Today";
const kTVScreenButtonFirstText = "Populars";
const kTVScreenButtonSecondText = "On Tv";
const kTVScreenButtonThirdText = "Top Rated";
const kHomeScreenTitleText = "The Films";
...
const kDrawerAboutDescText =
    "Assalamu'alaikum, Saya seorang Mobile Flutter developer, API yang saya gunakan yaitu themoviedb API. Untuk key themoviedb API, kalian register terlebih dahulu di website resmi themoviedb.";
